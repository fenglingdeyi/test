...
- (void)defaultSettings{
    ...
    _progressBackgroundColor = [UIColor grayColor];
...
-(void)drawRect:(CGRect)rect{
    ...
    CGRect rect1 = CGRectMake(0, 0, self.frame.size.width, 14);
...
//        if (i == self.step) {
//            
//            rect.size.width = 26.f;
//        }
//        else{
//            rect.size.width = 16.f;
//            
//        }
//
