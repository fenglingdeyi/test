...
{
    SDProgressHUD *hud = [SDProgressHUD showMessage:message detail:nil showView:nil img:nil time:1.0 aplhaBackground:isShowBlackBackground isAutoDismis:YES];
...
{
    SDProgressHUD *hud = [SDProgressHUD showMessage:message detail:detail showView:nil img:nil time:1.0 aplhaBackground:isShowBlackBackground isAutoDismis:NO];
